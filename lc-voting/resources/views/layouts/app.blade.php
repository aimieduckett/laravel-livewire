    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                ...
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse recusandae nihil iure laudantium natus tempora modi fugiat, blanditiis soluta provident vitae nesciunt unde? Non repellendus deleniti tempora, quos facilis, veritatis voluptates vitae voluptatum nihil libero distinctio natus modi, suscipit quis!
            </div>
            <div class="w-175">
