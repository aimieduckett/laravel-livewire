                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    >
                        ...
                        >
                            ...
                            <ul
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialogue rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                                x-cloak
    ...
    <div class="buttons-container flex items-center justify-between mt-5">
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div class="relative" x-data=" { isOpen: false }">
                ...
                <div
                    class="absolute z-10 w-64 md:w-104 text-left font-semibold text-sm bg-white shadow-dialogue rounded-xl mt-2"
                    x-show="isOpen"
                    x-transition
                    x-cloak
                    @click.away="isOpen = false"
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            ...
                            >
                                <svg
                                    class="text-gray-600 w-4 -rotate-45"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="2"
            ...
            <div class="relative" x-data="{ isOpen:false }">
                ...
                <div
                    class="absolute z-20 w-64 md:w-76 text-left font-semibold text-sm bg-white shadow-dialogue rounded-xl mt-2"
                    x-show="isOpen"
                    x-transition
                    x-cloak
                    @click.away="isOpen = false"
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input
                                        class="form-radio bg-gray-200 text-gray-600 border-none"
                                        type="radio"
                                        checked=""
                                        name="radio-direct"
                                        value="1"
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input
                                        class="form-radio bg-gray-200 text-purple border-none"
                                        type="radio"
                                        name="radio-direct"
                                        value="2"
                                    />
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input
                                        class="form-radio bg-gray-200 text-yellow border-none"
                                        type="radio"
                                        name="radio-direct"
                                        value="3"
                                    />
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input
                                        class="form-radio bg-gray-200 text-green border-none"
                                        type="radio"
                                        name="radio-direct"
                                        value="3"
                                    />
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input
                                        class="form-radio bg-gray-200 text-red border-none"
                                        type="radio"
                                        name="radio-direct"
                                        value="3"
                                    />
                        ...
                        <div>
                            <textarea
                                ...
                                rows="3"
                                class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2"
                                placeholder="Add an updated comment (optional)"
                            ></textarea>
                        </div>
                        <div
                        ...
                        <div>
                            <label class="font-normal inline-flex items-center">
                                <input
                                    class="form-checkbox rounded bg-gray-200"
                                    type="checkbox"
                                    name="notify_voters"
                                    checked=""
                                />
       ...
       <div class="comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    class="flex items-center space-x-2">
                       <button
                            @click="isOpen = !isOpen"
                            class="relative bg-gray-100 z-10 hover:bg-gray-200 border rounded-full h-7 transition duration-150 ease-in py-2 px-3"
                        >
                            <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"></svg>
                            <ul
                                x-cloak
                                ...
                                @click.away="isOpen = false"
                                @keydown.escape.window="isOpen = false"
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialogue rounded-xl py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                            >
                                <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a></li>
                                <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                            </ul>
        ...
        >
            ...
            <div class="w-full mx-4 py-6">
                <h4 class="text-xl font-semibold">
                    <a href="#" class="hover:underline"
                        >Status changed to 'Under Consideration'</a
                    >
                </h4>
                <div class="text-gray-600 mt-3 line-clamp-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
